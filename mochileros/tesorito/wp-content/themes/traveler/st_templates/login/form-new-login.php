...
<form class="register_form" data-reset="<?php echo esc_attr($reset) ?>"  method="post" action="<?php echo esc_url(add_query_arg(array( 'url'=>STInput::request('url') )))?>" enctype="multipart/form-data">
    <div class="row mt30">
        <div class="col-md-12">
    ...
    <div class="text-center mt20">
        <button name="btn-reg" class="btn btn-primary btn-lg" type="submit" ><?php _e("Register",ST_TEXTDOMAIN) ?></button>
    </div>
</form>

<form class="form_upload_certificates"  method="post" action="<?php echo esc_url(add_query_arg(array( 'url'=>STInput::request('url') )))?>" enctype="multipart/form-data">
</form>