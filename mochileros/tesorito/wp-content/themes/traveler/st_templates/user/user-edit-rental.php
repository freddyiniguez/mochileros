...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="st_title" type="text" placeholder="<?php echo __('Name of Rental', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo esc_html($post->post_title) ?>">
                ...
                <div class="row">
					...
					<div class="col-md-6 clear">
						<div class="form-group form-group-icon-left">
							...
							<i class="fa  fa-phone input-icon input-icon-hightlight"></i>
							<input id="st_fax" name="st_fax" type="text" placeholder="<?php _e('Fax Number',ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo get_post_meta($post_id,'st_fax',true) ?>">
