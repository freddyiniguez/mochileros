                ...
                <div class="row">
					...
					<div class="col-md-6">
						<div class="form-group form-group-icon-left">
							...
							<i class="fa  fa-phone input-icon input-icon-hightlight"></i>
							<input id="cars_fax" name="cars_fax" type="text" placeholder="<?php _e('Fax Number',ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo get_post_meta($post_id,'cars_fax',true) ?>">
