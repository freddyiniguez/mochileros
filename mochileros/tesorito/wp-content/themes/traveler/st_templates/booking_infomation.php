        ...
        <table cellspacing="0px" cellpadding="0" width="100%" class="tb_cart_total">
            ...
            <tr>
                ...
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px;">
                    <?php echo TravelHelper::format_money_from_db($adult_price,$currency,$rate) ?>
                </td>
            </tr>
			<?php }?>
			<?php if($child_price){?>
            <tr>
                ...
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px;">
                    <?php echo TravelHelper::format_money_from_db($child_price,$currency,$rate) ?>
                </td>
            </tr>
			<?php }?>
			<?php if($infant_price){?>
            <tr>
                ...
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px;">
                    <?php echo TravelHelper::format_money_from_db($infant_price,$currency,$rate) ?>
                </td>
            </tr>
			<?php }?>
            <?php endif; ?>
            ...
            <tr>
                ...
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px;">
                    <?php echo TravelHelper::format_money_from_db($price_equipment,$currency,$rate) ?>
                </td>
            </tr>
            <?php endif; ?>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: right; border-bottom: 1px dashed #ccc;padding:10px;">-
                    <?php echo TravelHelper::format_money_from_db($coupon_price,$currency,$rate); ?>
                </td>
            </tr>
            <?php endif; ?>
            <tr>
