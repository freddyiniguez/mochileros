	...
	<div class="row">
		<div class="col-xs-6 col-sm-4 col-lg-2">
			<div class="form-group">
				...
				<input readonly="readonly" id="field-hotel-start" data-post-id="<?php echo get_the_ID(); ?>" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control checkin_hotel" value="<?php echo $check_in; ?>" name="start" type="text">
			</div>
		</div>
		<div class="col-xs-6 col-sm-4 col-lg-2">
			<div class="form-group">
				...
				<input readonly="readonly" id="field-hotel-end" data-post-id="<?php echo get_the_ID(); ?>" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control checkout_hotel" value="<?php echo $check_out; ?>" name="end" type="text">
			</div>
		</div>
		<div class="col-xs-6 col-sm-4 col-lg-2">
