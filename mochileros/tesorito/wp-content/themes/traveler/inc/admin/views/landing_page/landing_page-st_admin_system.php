...
$theme=wp_get_theme();
?>
<!-- <a href="#" class="help_tip">
    [?]
    <span class='st_tooltip'>Tool tip content</span>
    </a> -->
            ...
            <td><?php
                ...
                if ( function_exists( 'phpversion' ) ) {
                    ...
                    if ( version_compare( $php_version, '5.3', '<' ) ) {
                        echo '<mark class="error">' . sprintf( __( '%s - We recommend a minimum PHP version of 5.3. See: <a href="%s" target="_blank">How to update your PHP version</a>', ST_TEXTDOMAIN ), esc_html( $php_version ), 'http://docs.woothemes.com/document/how-to-update-your-php-version/' ) . '</mark>';
                    } else {
