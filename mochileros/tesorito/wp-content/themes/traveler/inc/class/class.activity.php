    ...
    class STActivity extends TravelerObject
    {
        ...
        function _get_where_query($where)
        {
            ...
            if($st_google_location = STInput::request('st_google_location', '')){
                ...
                $st_administrative_area_level_1 = sanitize_title(STInput::request('location_name', ''));
                ...
                if(TravelHelper::isset_table('st_glocation')){
                    ...
                    if(!empty($st_administrative_area_level_1)){
                        $clause .= " AND (administrative_area_level_1 LIKE '%{$st_administrative_area_level_1}%'  OR administrative_area_level_2 LIKE '%{$st_administrative_area_level_1}%' )";
                    }
                    if(!empty($st_country)){
            ...
            if(isset($_REQUEST['location_name']) && !empty($_REQUEST['location_name'])){
