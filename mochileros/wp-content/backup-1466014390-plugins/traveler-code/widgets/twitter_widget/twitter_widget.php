...
class STTwitterWidget extends WP_Widget
{
	...
	public function form( $instance ) {
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:',STP_TEXTDOMAIN ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
		</p>
		<p>
		<label for="<?php echo $this->get_field_id( 'user_id' ); ?>"><?php _e( 'Twitter User:',STP_TEXTDOMAIN ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'number_tweet' ); ?>"><?php _e( 'Number of Tweet (default is 5):',STP_TEXTDOMAIN ); ?></label>
