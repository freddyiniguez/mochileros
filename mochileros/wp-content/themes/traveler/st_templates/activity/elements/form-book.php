            ...
            ?>
                <div class="row ">
                    <div class="col-xs-12 ">
                        ...
                        <input readonly="readonly" placeholder ="<?php echo __("Select a tour in the calendar", ST_TEXTDOMAIN) ; ?>" id="check_in" type="text" name="check_in" value="<?php echo $check_in; ?>" class="form-control">
                    </div>
                    <div class="col-xs-12 mt10" style="display: none;">
                        <strong><?php _e('Arrive date',ST_TEXTDOMAIN)?>: </strong>
                        
                        <input readonly="readonly" id="check_out" type="text" name="check_out" value="<?php echo $check_out; ?>" readonly="readonly" class="form-control">
                    </div>
                </div>
            <?php else: ?>
            <div class="row">
                ...
                <div id="list_activity_item" data-type-tour="<?php echo $type_tour; ?>" style="display: none; width: 500px; height: auto;">
