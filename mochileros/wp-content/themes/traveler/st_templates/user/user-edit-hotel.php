...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="st_title" type="text" placeholder="<?php _e("Title",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo esc_html($post->post_title) ?>">
    ...
    <div class="form-group">
        ...
        <textarea id="desc" name="st_desc" rows="6"  class="form-control"><?php echo esc_html($post->post_excerpt) ?></textarea>
