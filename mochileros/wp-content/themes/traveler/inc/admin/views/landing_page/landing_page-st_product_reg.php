...
if(!$_username or !$_api_key or !$_purchase_code):
    ?>
        ...
        <div class="traveler-important-notice registration-form-container">
			...
			<form id="traveler_product_registration" method="post" action="<?php echo admin_url('admin.php?page=st_product_reg') ?>">
				<div class="traveler-registration-form">
						...
						<input type="text" name="tf_username" id="tf_username" placeholder="<?php _e('Themeforest Username',ST_TEXTDOMAIN)?>" value="">
						<input type="text" name="tf_api" id="tf_api" placeholder="<?php _e('Enter API Key',ST_TEXTDOMAIN)?>" value="">
						<input type="text" name="tf_purchase_code" id="tf_purchase_code" placeholder="<?php _e('Enter Themeforest Purchase Code',ST_TEXTDOMAIN)?>" value="">
