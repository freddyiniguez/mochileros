		...
		static function _getInfoActivity()
		{
			...
			if (get_post_type($activity_id) == 'st_activity') {
				...
				if ($type_activity && $type_activity == 'daily_activity') {
					...
					$duration = get_post_meta($activity_id, 'duration_day', TRUE);
					$duration_unit = get_post_meta($activity_id, 'duration_unit', TRUE);
...
//                    ),
					...
					array(
						'label' => __('Hide No of adult in booking form', ST_TEXTDOMAIN),
					...
					array(
						'label' => __('Hide No of child in booking form', ST_TEXTDOMAIN),
					...
					array(
						'label' => __('Hide No of infant in booking form', ST_TEXTDOMAIN),
...
//                      ),
		...
		function _check_validate()
		{
			...
			if (STInput::request('section', '') != 'edit_order_item') {
				...
				$duration = ($type_activity = 'daily_activity') ? get_post_meta($item_id, 'duration_day', TRUE) : '';
