 ...
 * */
    class STCart
    {
        ...
        static function  booking_form_submit( $item_id = ''){
            if(STInput::post('st_payment_gateway') and check_ajax_referer('travel_order','security' )){
                ...
                $payment_gateway_id = STInput::post('st_payment_gateway');
                ...
                if($insert_post){
                    ...
                    update_post_meta($insert_post,'currency_name', TravelHelper::get_current_currency('name'));
				...
				return array(
					'status'=>FALSE,
					'message'=>__("Your session has expired. Please reload this page",ST_TEXTDOMAIN),
					'reload'=>1
				);
			}
        }
