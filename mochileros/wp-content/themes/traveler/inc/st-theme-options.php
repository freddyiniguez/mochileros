...
//        ),
		...
		array(
			'id'		=>'st_booking_hide_create_account',
			'label'		=>__('Hide Create Account Option',ST_TEXTDOMAIN),
			'desc'		=>__('Hide Create Account Option in checkout page',ST_TEXTDOMAIN),
			'type'		=>'on-off',
			'std'		=>'off',
            'section' 	=> 'option_booking' ,
		),
        ...
        array(
            ...
            'label'       => __( 'Hotel Advance Search fields ', ST_TEXTDOMAIN ),
            'type'        => 'list-item',
            'section'     => 'option_hotel',
        ...
        array(
            ...
            'label'     => __("Allow Rental Advance Search" , ST_TEXTDOMAIN),
            'type'      => 'on-off',
            'std'       => "off",
            'section'   => 'option_rental'
        ),
        array(
            ...
            'label'    => __( 'Rental Advance Search Fields' , ST_TEXTDOMAIN ) ,
            'desc'     => __( 'Rental Advance Search Fields' , ST_TEXTDOMAIN ) ,
            'type'     => 'Slider' ,
            'section'  => 'option_rental' ,
        ...
        array(
            ...
            'label'    => __( 'Car Advance Search Fields' , ST_TEXTDOMAIN ) ,
            'desc'     => __( 'Car Advance Search Fields' , ST_TEXTDOMAIN ) ,
            'type'     => 'Slider' ,
            'section'  => 'option_car' ,
        ...
        array(
            ...
            'label'     => __("Tour allow advance search " , ST_TEXTDOMAIN),
            'type'      => 'on-off',
            'std'       => "off",
            'section' => 'option_activity_tour'
        ),
        array(
            ...
            'label'    => __( 'Tour Advance Search Fields' , ST_TEXTDOMAIN ) ,
            'desc'     => __( 'Tour Advance Search Fields' , ST_TEXTDOMAIN ) ,
        ...
        array(
            ...
            'label'   => __( 'Allow Activity Advance Search' , ST_TEXTDOMAIN ) ,
            'type'    => 'on-off' ,
            'std'     => 'off' ,
            'section' => 'option_activity'
        ) ,
        array(
            ...
            'label'    => __( 'Activity Advance Search Fields' , ST_TEXTDOMAIN ) ,
            'desc'     => __( 'Activity Advance Search Fields' , ST_TEXTDOMAIN ) ,
        ...
        array(
            'id'     => 'partner_custom_layout_menu_tab',
            'label'  =>__("Menu Dashboard",ST_TEXTDOMAIN),
            'type'  =>'tab',
            'section'  =>'option_partner',
        ),
        array(
